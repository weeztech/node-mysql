...
Query.prototype['ResultSetHeaderPacket'] = function (packet) {
  if (packet.fieldCount === null) {
    ...
    var rowsAsArray = this.rowsAsArray
    if (rowsAsArray) {
        if (Array.isArray(rowsAsArray)) {
            rowsAsArray = rowsAsArray[this._resultSetIndex]
        }
        this._resultSet.rows.rowsAsArray = rowsAsArray;
    }
  }
};
...
Query.prototype['RowDataPacket'] = function (packet, parser, connection) {
    var rowsAsArray = this._resultSet.rows.rowsAsArray;
    packet.parse(parser, this._resultSet.fieldPackets, this.typeCast, this.nestTables, connection, rowsAsArray);
    if (rowsAsArray && !this.nestTables){
